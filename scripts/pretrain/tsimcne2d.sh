...
echo Training tsimcne2d on cifar10 for 500 epochs...
torchrun --standalone --nproc_per_node=2 -m dual_ifm.tsimcne.train2d_multigpu --config-name tsimcne2d train.batch_size=4096 train.epochs=[400,25,75]

echo Evaluate tsimcne2d on cifar10...
python -m dual_ifm.tsimcne.eval --config-name tsimcne2d train.epochs=[400,25,75]
